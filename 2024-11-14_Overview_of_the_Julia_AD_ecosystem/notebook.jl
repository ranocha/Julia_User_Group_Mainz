...
Babylonian(MyDual(100.0, 1.0))

# ╔═╡ 8881a438-fcaa-4fce-91bd-cdb176c87b72
let 
	@variables x
	Symbolics.derivative(Babylonian(x, N=2), x; simplify = true)
end
...
let 
	du = zero(u)
	autodiff(Enzyme.Reverse, G!, DuplicatedNoNeed(zeros(2), v), 
						         Duplicated(u, du))
	du
end
...
manifest_format = "2.0"
project_hash = "481adaeaef9bca65cad2f1278067a7aa38ca8261"
...
git-tree-sha1 = "159306f3e8fa7a3380afd8daaa0f13efe86d7fde"
