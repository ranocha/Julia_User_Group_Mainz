...
# ╔═╡ 3d9781d3-cbb0-4a69-ab4d-5997f3251f0f
using Trixi
...
# ╔═╡ 223dec01-4636-493d-9d2a-843b05d5eb44
begin
	# PassiveTracerEquations setup for Kelvin-Helmholtz instability
	using Trixi: rotate_to_x
	import Trixi: entropy, cons2entropy
	...
	function Trixi.varnames(variables::typeof(cons2cons),
	 ...
	 function Trixi.varnames(variables::typeof(cons2prim),
	                   tracer_equations::PassiveTracerEquations)
	    (; flow_equations) = tracer_equations
	    flow_varnames = varnames(variables, flow_equations)
	    n_tracers = ntracers(tracer_equations)
	...
	@inline function tracers(u, tracer_equations::PassiveTracerEquations)
	    ...
	    rho = Trixi.density(u, tracer_equations)
	    return SVector(ntuple(i -> u[n_flow_variables + i] / rho, Val(n_tracers))...)
	end
	
	@inline function Trixi.cons2prim(u, tracer_equations::PassiveTracerEquations)
	    (; flow_equations) = tracer_equations
	    return SVector(cons2prim(flow_variables(u, tracer_equations), flow_equations)...,
	                    tracers(u, tracer_equations)...)
	end
	
	@inline function Trixi.prim2cons(u, tracer_equations::PassiveTracerEquations)
	    (; flow_equations) = tracer_equations
	...
	for f in [:density, :pressure, :density_pressure, :max_abs_speeds]
	    @eval @inline function Trixi.$f(u, tracer_equations::PassiveTracerEquations)
	        (; flow_equations) = tracer_equations
	        u_flow = flow_variables(u, tracer_equations)
	        return Trixi.$f(u_flow, flow_equations)
	    end
	end
	
	@inline function Trixi.max_abs_speed_naive(u_ll, u_rr, orientation_or_normal,
	                                     tracer_equations::PassiveTracerEquations)
	    (; flow_equations) = tracer_equations
	...
	@inline function Trixi.flux(u, orientation::Integer,
	    ...
	    v_normal = u[1 + orientation] / Trixi.density(u, tracer_equations)
	...
	@inline function (f::FluxTracerEquationsCentral)(u_ll, u_rr,
	   ...
	   flux_flow = f.flow_flux(u_flow_ll, u_flow_rr, orientation_or_normal_direction,
	                           flow_equations)
	   flux_rho = Trixi.density(flux_flow, flow_equations)
	   rho_ll = Trixi.density(u_ll, flow_equations)
	   rho_rr = Trixi.density(u_rr, flow_equations)
	...
	@inline function Trixi.boundary_condition_slip_wall(u_inner, orientation::Int,
	                                              direction, x, t,
	...
	@inline function Trixi.boundary_condition_slip_wall(u_inner, normal_direction::AbstractVector,
	                                              direction, x, t,
	                                              surface_flux_function,
	                                              equations::PassiveTracerEquations)
	...
	function cons2density_and_tracers(u, tracer_equations::PassiveTracerEquations)
	    return SVector(Trixi.density(u, tracer_equations), tracers(u, tracer_equations)...)
	end
	
	function Trixi.varnames(variables::typeof(cons2density_and_tracers),
	                  tracer_equations::PassiveTracerEquations)
	    n_tracers = ntracers(tracer_equations)
...
# ╔═╡ 6b353022-78c1-4e8f-acf4-6ca83c6aa3fc
begin
md"""$$\Large \boldsymbol{u}_t + \nabla \cdot \boldsymbol{f}_a(\boldsymbol{u}) = \boldsymbol{s}(\boldsymbol{u})$$
"""
end # LaTeX \newcommand does not work when exporting as HTML
...
# ╔═╡ ff5ae553-3266-4b78-8bef-bdb82368c081
html"""
<h1 class="custom-heading"><center> Trixi.jl and me: Lax-Wendroff integration</h1>
"""

# ╔═╡ ce49c391-695b-49af-a2ce-0d75c443f1e2
html"""
<center>
...
# ╔═╡ 5a2bc2ca-d512-4a01-bd32-2edd41f90830
html"""
<a href="www.github.com/arpit-babbar/TrixiLW.jl" class="subsubtitle-heading"> <center> <b> github.com/arpit-babbar/TrixiLW.jl</a></center></b>
"""
...
begin
	...
	save_solution = SaveSolutionCallback(interval = 100, solution_variables = cons2cons)
...
# ╔═╡ 68a128ab-7d79-4982-a4c4-10e2834d3dec
html"""
<h1 class="custom-heading"><center>Adding your own conservation law</center></h1>
"""

# ╔═╡ 77a3cd6f-4f7e-4c4b-bf6b-a73999781855
html"""
<center class="subsubtitle-heading"> 1-D Reactive Euler's equations </center>
"""

# ╔═╡ 08931ea6-fe9c-4f01-9714-0e37ac14402b
md"""
$$\large\frac{\partial}{\partial t}  \left(\begin{array}{c}
\rho\\
\rho v_1\\
E \\
\boldsymbol{\rho z}
...
p + \rho v_1^2\\
(E + p) v_1 \\
\boldsymbol{\rho v_1 z}
\end{array}\right) = \boldsymbol{0}$$

$$\large E = E (\rho, v_1, p) = \frac{p}{\gamma - 1} + \frac{1}{2}
\rho v_1^2 + \boldsymbol{q_0 z}$$
"""

# ╔═╡ 21ec3188-18cc-4854-b19a-ccd2a812fc1c
html"""
<h1 class="custom-heading"><center>Define equation datatype</center></h1>
"""

# ╔═╡ aef40dba-ca77-47a4-95e1-5e5e010e2314
begin
	struct ReactiveEulerEquations1D{RealT <: Real} <:
			AbstractEquations{1, 4} # 1D system with 4 equations
		q0::RealT
		euler_equations::CompressibleEulerEquations1D{RealT}
	end

	# Constructor
	function ReactiveEulerEquations1D(gamma, q0)
		euler_equations = CompressibleEulerEquations1D(gamma)
		return ReactiveEulerEquations1D(q0, euler_equations)
	end
end

# ╔═╡ f5935690-12d7-46e9-a382-b64f9728529e
html"""
<h1> <center> Display, plotting and auxiliary </center> </h1>
"""

# ╔═╡ 9a332322-dfc5-41d8-8165-c12753e77ce0
begin
    import Trixi: varnames
	function varnames(variables_type::typeof(cons2cons),
					  equations::ReactiveEulerEquations1D)
    	(varnames(variables_type, equations.euler_equations)..., "rho_Z")
	end
end

# ╔═╡ cb362244-accf-4e6f-9fc3-15c197e308b8
@inline u_euler(u, equations::ReactiveEulerEquations1D) = SVector(u[1], u[2], u[3])

# ╔═╡ 7580ce98-dad3-4e95-b406-7c4c8817ab91
html"""
<h1> <center> Physical flux </center> </h1>
"""

# ╔═╡ d0b5be8a-ace6-48f8-a01f-f02ce5bb50ab
begin
	import Trixi: flux

	@inline function flux(u, orientation::Integer,
			equations::ReactiveEulerEquations1D)
		@unpack euler_equations, q0 = equations
		@unpack gamma = euler_equations
	    f1, f2, f3 = flux(u_euler(u, equations), orientation, euler_equations)

		v1 = u[2] / u[1]
		p_extra = - (gamma - 1.0) * q0 * u[4]
		flux_reactive = SVector(f1, f2 + p_extra, f3 + v1 * p_extra, v1 * u[4])
	end
end

# ╔═╡ ef343983-f5f2-49ec-aba5-1d1133e74774
html"""
<h1> <center> Wave speeds</center> </h1>
<center  class="subsubtitle-heading"> Used for numerical dissipation, time step sizes </center>
"""

# ╔═╡ 6fcd5fc0-feb8-4f55-9d95-c79df69d6a9e
begin
import Trixi: max_abs_speed_naive, max_abs_speeds
@inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer,
                                     equations::ReactiveEulerEquations1D)
    rho_ll, rho_v1_ll, rho_e_ll, rho_z_ll = u_ll
    rho_rr, rho_v1_rr, rho_e_rr, rho_z_rr = u_rr

	@unpack q0, euler_equations = equations
	@unpack gamma = euler_equations

    # Calculate primitive variables and speed of sound
    v1_ll = rho_v1_ll / rho_ll
    v_mag_ll = abs(v1_ll)
    p_ll = (gamma - 1) * (rho_e_ll - 0.5f0 * rho_ll * v_mag_ll^2 - q0 * rho_z_ll)
    c_ll = sqrt(gamma * p_ll / rho_ll)
    v1_rr = rho_v1_rr / rho_rr
    v_mag_rr = abs(v1_rr)
    p_rr = (gamma - 1) * (rho_e_rr - 0.5f0 * rho_rr * v_mag_rr^2 - q0 * rho_z_rr)
    c_rr = sqrt(gamma * p_rr / rho_rr)

    λ_max = max(v_mag_ll, v_mag_rr) + max(c_ll, c_rr)
end

@inline function max_abs_speeds(u, equations::ReactiveEulerEquations1D)
    @unpack euler_equations, q0 = equations
    @unpack gamma = euler_equations
    rho, rho_v1, rho_e = u
    v1 = rho_v1 / rho
    p = (gamma - 1) * (rho_e - 1 / 2 * rho * v1^2 - q0 * u[4])
    c = sqrt(gamma * p / rho)
...
# ╔═╡ 1cd6954b-f9ee-478c-928f-4daff592bc16
html"""
<h1> <center> Test the equation with a blast wave </center> </h1>
"""

# ╔═╡ a87056f7-2741-468d-81cd-0ffc5558912b
begin
	 # gamma = 1.4, q0 = 1.0
	equations_reactive = ReactiveEulerEquations1D(1.4, 1.0)
	
	import Trixi: initial_condition_weak_blast_wave
	
	function initial_condition_weak_blast_wave(x, t,
	                                           equations::ReactiveEulerEquations1D)
		ic_euler = initial_condition_weak_blast_wave(x, t, equations.euler_equations)
		return SVector(ic_euler..., 1.0)
	end
end

# ╔═╡ d79c57db-2793-4045-950a-7004e9f3cedd
html"""
<h1> <center> Setup solver with shock capturing </center> </h1>
"""

# ╔═╡ ece08483-bcfd-48aa-9dbf-1a051f4d402f
begin
	surface_flux = flux_lax_friedrichs
	basis = LobattoLegendreBasis(3)
	indiciator_variable = (u, equations) -> u[1] * u[3] * u[4]
	indicator_sc = IndicatorHennemannGassner(equations, basis,
                                         alpha_max = 0.5,
                                         alpha_min = 0.001,
                                         alpha_smooth = true,
                                         variable = indiciator_variable)
	volume_integral = VolumeIntegralShockCapturingHG(indicator_sc;
	                                                 volume_flux_fv = surface_flux)
	solver_sc = DGSEM(basis, surface_flux, volume_integral)
end

# ╔═╡ af9e14ee-f405-4262-b71f-5c58299bd6cd
html"""
<h1> <center> Mesh and put everything together </center> </h1>
"""

# ╔═╡ 70dd0280-17ef-4157-9e5e-900d0720cf68
begin
	mesh_1d = TreeMesh(-2.0, 2.0, initial_refinement_level = 5,
	                   n_cells_max = 10_000)
	
	semi_blast = SemidiscretizationHyperbolic(
		mesh_1d, equations_reactive, 
		initial_condition_weak_blast_wave, 
		solver_sc)
	tspan = (0.0, 1.0)
	ode_blast = semidiscretize(semi_blast, tspan)
end;

# ╔═╡ 6b427adc-224b-4c82-826e-cfbe2ab6e2a7
html"""
<h1> <center> Solve and plot </center> </h1>
"""

# ╔═╡ e11c62e4-60aa-42e8-accb-a15ada13853f
sol_blast = solve(ode_blast, 
			CarpenterKennedy2N54(williamson_condition = false),
            dt = 1.0,
            save_everystep = false, 
	        callback = CallbackSet(stepsize_callback));

# ╔═╡ a7787f79-e68c-43c3-b881-df68e1fdeed7
plot(sol_blast, size = (700, 700))

# ╔═╡ 34ca75b2-b110-4d37-bb1f-27e3be4d70d6
html"""
<h1> <center> Additional functions typically needed </center> </h1>
"""

# ╔═╡ 96ed1ce5-29d7-4cfe-9c02-05d20feb951e
begin
	import Trixi: cons2prim, pressure, density_pressure

	
	function pressure(u, equations::ReactiveEulerEquations1D)
		@unpack euler_equations, q0 = equations
		@unpack gamma = euler_equations
		rho, rho_v1, rho_e, rho_z = u
		v1 = rho_v1 / rho
		p = (gamma - 1) * (rho_e - 1 / 2 * rho * v1^2 - q0 * u[4])
		return p
	end

	function density_pressure(u, equations::ReactiveEulerEquations1D)
		return u[1] * pressure(u, equations)
	end
	
	function cons2prim(u, equations::ReactiveEulerEquations1D)
		rho, rho_v1, rho_e, rho_z = u
		v1 = rho_v1 / rho
		p = pressure(u, equations)
		z = rho_z / rho
		return SVector(rho, v1, p, z)
	end

	function Trixi.varnames(variables_type::typeof(cons2prim),
					  equations::ReactiveEulerEquations1D)
		(Trixi.varnames(variables_type, equations.euler_equations)..., "Z")
	end
end
...
begin	
	...
	volume_integral_ = VolumeIntegralShockCapturingHG(indicator_;
	                                                 volume_flux_fv = surface_flux)
	solver_ = DGSEM(basis, surface_flux, volume_integral_)
...
# ╔═╡ 2cce047b-e492-44d2-9dcb-769d020fef61
html"""
<h1> <center> Extension of boundary conditions </center> </h1>
"""

# ╔═╡ bfbd6332-83a2-48e6-95aa-eee17d56a011
begin
	import Trixi: boundary_condition_slip_wall
	
	@inline function boundary_condition_slip_wall(
		u_inner, orientation, direction, x, t,surface_flux_function, equations::ReactiveEulerEquations1D)
	
		u_inner_euler = u_euler(u_inner, equations)
		f_euler = boundary_condition_slip_wall(
			u_inner_euler, orientation, direction, x, t, surface_flux_function,
			equations
		)
		rho_z_v = u[4] * u[2] / u[1]
		return SVector(f_euler[1], f_euler[2], f_euler[3], rho_z_v)
	end
end

# ╔═╡ a7efe88d-c129-4c56-88e5-1ea7765c7a01
html"""
<h1 class="custom-heading"><center> Kelvin-Helmholtz instability with tracer</h1>
"""

# ╔═╡ 76b2cf3c-aed8-49ee-86bd-dd9b1bf1386d
begin
	gamma = 1.4
...
# ╔═╡ 09fdc134-5fac-46ae-8945-24641a923d5a
begin
    surface_flux_ = flux_lax_friedrichs
    volume_flux = FluxTracerEquationsCentral(flux_ranocha)
    dg_solver = DGSEM(polydeg = 3, surface_flux = surface_flux_,
	...
	ode_kh = semidiscretize(semi_kh, (0.0, 1.0))
end;

# ╔═╡ 29fa9203-94d8-474b-bc96-8639bb97fa95
begin
	tstops = range(tspan..., length = 101)
	integrator = init(ode_kh, SSPRK43(); save_everystep = false)
	...
	for _ in TimeChoiceIterator(integrator, tstops)
		...
		fig = plot(fig_rho, fig_xi1;
				   ...
				   margin = 0.0 * Plots.cm, aspect_ratio = :equal)
...
manifest_format = "2.0"
project_hash = "c6b56f9ae18b860d1d8d192472481b161287ef01"
