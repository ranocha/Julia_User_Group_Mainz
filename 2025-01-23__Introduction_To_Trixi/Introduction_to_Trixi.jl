...
md"""
[www.github.com/arpit-babbar/TrixiLW.jl](www.github.com/arpit-babbar/TrixiLW.jl)
"""
...
begin
	...
	function varnames(variables_type::typeof(cons2prim), 
					  equations::ReactiveEulerEquations1D)
    	(varnames(variables_type, equations.euler_equations)..., "Z")
	end
end
...
begin
	...
	@inline function flux(u, orientation::Integer,
			equations::ReactiveEulerEquations1D)
		@unpack euler_equations = equations
		@unpack gamma = euler_equations
	    f1, f2, f3 = flux(u_euler(u, equations), equations.euler_equations)
	
		v1 = u[2] / u[1]
		p_extra = - (gamma - 1.0) * equations.q0 * u[4]
		flux_reactive = (f1, f2 + p_extra, f3 + v1 * p_extra, v1 * u[4])
	end
end
...
@inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer,
    ...
    v_mag_ll = abs(v1_ll)
    p_ll = (gamma - 1) * (rho_e_ll - 1 / 2 * rho_ll * v_mag_ll^2 - q0 * u_ll[4])
    c_ll = sqrt(gamma * p_ll / rho_ll)
    v1_rr = rho_v1_rr / rho_rr
    v_mag_rr = abs(v1_rr)
    p_rr = (gamma - 1) * (rho_e_rr - 1 / 2 * rho_rr * v_mag_rr^2 - q0 * u_rr[4])
